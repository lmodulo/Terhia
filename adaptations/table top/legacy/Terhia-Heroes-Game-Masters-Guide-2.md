...
**v0.2 — 25 September 2026** (v0.1 the same day). Companion to Terhia-Heroes-Players-Guide.md v0.2 (PG). Built from Terhia-Heroes-GM-Guide-Handoff.md and Terhia-Canon.md v1.2. Mechanics only; no adventures. Every rule that touches canon is a G-row in §13 for Joe's ratification. Canon is not edited by this file. **A table can play from the working readings as written;** the register is the author's ratification queue, not a list of rulings the GM must make before a session.
...
| 6–11 | 2 | Two Actions a turn. An Adept Elementalist casts and Cores; a Master Hexblade Strikes twice (four attacks, since the Master Strike Action already makes two — counted in §12.2) |
...
Guard, Ward, and Attack keep the handoff's proposal: they set the 55–65% same-rank hit rate, and Tempo does not change hit rates. Vigor is rescaled at Adept and above because Tempo changes what a party does in a round; Novice keeps the handoff's figures (v0.1 raised the Novice Boss to 75 on a Novice Strike that carried a Rank Die it does not have — §12.1). Handoff figures in parentheses where they changed.
...
A Guru martial PC (level 13, Tempo 3) hits a Mob's Guard of 14–16 about 95% of the time, so with Strikes alone it does about 140 Cohesion a round (§12.1: a Guru Strike is two attacks at weapon + 2 RD + Key, 47 an Action; v0.1 modelled 34 at the own-tier hit rate and got 61). Against a Novice platoon (160): round 1 → 19, under half — automatic rout. Adept platoon (240): round 1 → 99, under half — rout. Master platoon (320): round 1 → 186; round 2 → 52, under half — rout in round 2. **One round at Novice and Adept drill, two at Master drill,** Strikes alone; the Guru abilities that name Cohesion can only make it faster. The handoff asked for 2–4; the Master drill's two is the platoon standard (a levy is not), and the figure fits the canon line. If Joe wants 2–4 at every drill, Cohesion 6 / 9 / 12 per member does it (G39). A Master party of four (130 or more a round) routs a Novice platoon in one round; a Novice party of four (~17 a round) cannot break a platoon and should not be shown one except as scenery or as the thing to hide from.
...
v0.1 reconstructed this table from the handoff and got two lines wrong: the Novice Strike carried a Rank Die it does not have (PG §5: Novice is weapon + Key), and the Guru Strike was assumed at weapon + RD when the PG gives weapon + 2 RD, two attacks. Both are corrected. The representative weapon is a d8; the two-handed classes (maul, great-ax d12) run about +2 a hit above these lines, the Vanguard's glaive +1. A Guru's 0-Strain turn uses the Master Core form (PG §14, H38).
...
| Guru (13) | +6 | +14 | Master form: 3d12 + 6 = 25.5 | 4 RD + Key = 32 (*Open Door*) | 2 × (d8 + 2d12 + 6) = 47 |
...
Per Action, then per turn at the design Tempo (1 / 2 / 2 / 3). Caster turn = one costed ability + Cores. Figures are expected (after the multiplier).

| Rank | Core | Rank ability | Strike | **Martial / turn** | **Caster / turn** | **Party of four / round** (2 martial, 1 caster, 1 support at 0.7 caster) |
|:--|:-:|:-:|:-:|:-:|:-:|:-:|
| Novice | 4.2 | 4.2 | 4.9 | 4.9 | 4.2 | 17 (about 21 with resources) |
...
| Master, level 12 (Tempo 3) | 14.0 | 17.6 | 19.5 | 58.5 | 45.6 | 195 |
| Guru | 15.3 | 19.2 | 28.2 | 85 | 50 | 255 |
...
|:--|:--|:--|
| (a) Casters vs martials within ~20% single-target | Novice: martial +17%. Adept: caster +17% at Tempo 2 (+34% at level 5). Master: **martial +23%** (+28% at level 12). **Guru: martial +70%** (85 vs 50) | Master is the handoff's risk 4 and is the genre trade: areas hit several targets, and at two targets the Master caster is at parity, at three ahead. Guru is new in v0.2 and is the PG's Guru Strike (two attacks at weapon + 2 RD + Key, 47 an Action): at two targets the Guru caster is level, at one the martial is far ahead. **G34:** Joe to accept the trade or trim the Guru Strike to two attacks at weapon + RD + Key (34 an Action), which puts the Guru gap at Master's +23% |
...
| (c) Boss survives 3–4 rounds of a full party at full damage | Novice 60 / 17 = 3.5 (about 2.9 with resources); Adept 220 / 68 = 3.2 (level 5: 110 / 36 = 3.1); Master 450 / 132 = 3.4 (level 12: 675 / 195 = 3.5); Guru 800 / 255 = 3.1 | ✓ at every band as a floor. **At the table** a party spends about half its Actions on damage (§11.5): 6–7 rounds, one or two a phase, which is what a four-phase Master fight needs. Novice Boss Vigor returns to the handoff's 60; v0.1's 75 rested on the overstated Novice Strike |
| (d) Guru martial breaks a platoon of 40 in 2–4 rounds | §5.9: about 140 Cohesion a round at a Mob's Guard of 14–16 — Novice and Adept drill rout in one round, Master drill in two | Faster than the handoff's 2–4 and on target for the canon line ("a Guru can fight platoons"). **Alternative if Joe wants 2–4 at every drill:** Cohesion per member 6 / 9 / 12 instead of 4 / 6 / 8 (G39) |
...
Same columns as the PG's H-rows. **Status: all open** until Joe rules. The PG's H-rows are the other half of the register (§13.3); a G-row applied to the PG in v0.2 carries its H-number in the Where column.

| # | Rule | Touches canon | Where | Note / alternative |
|:-:|:--|:-:|:--|:--|
| G1 | Tempo: Actions 1 / 2 / 3 at levels 1 / 6 / 12; no costed ability twice a turn; one Ready a turn (D10) | No | §3; PG §5 (H34) | Alternative: Tempo at rank boundaries (9, 13) — loses "a Master Sorcerer casts three" |
...
| G39 | Platoon standard: a Guru martial routs a Novice or Adept drill in one round and a Master drill in two, Strikes alone | Yes: the platoon standard (Part VI) | §5.9 | Alternative for the handoff's 2–4: Cohesion 6 / 9 / 12 per member (G6) |
