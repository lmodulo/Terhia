...
| Chest | Guard +1 (above the armor value) | Guard +1 | Guard +2; Resist one damage kind |
...
Novice-grade gear is the starting kit: no intrinsic, no socket. Intrinsics stack across slots, never within one. **Weapons and shields** keep their §4 values and carry no tier and no socket in this draft (GM Guide G11).
